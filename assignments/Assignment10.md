...
Open the jupyter notebook titled ```10_evaluation_and_verifiers.ipynb```
...
1. Why is evaluating creative text harder than evaluating math answers?
2. What parts of parody lyrics can be verified automatically?
3. What parts still require human judgment?
4. How is a rhyme score similar to a verifier?
